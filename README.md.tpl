...
[![Github tag](https://badgen.net/github/tag/mandreljava/base.images.debian.11-bullseye.mandrel.22-3.java.17.mandrel-22-3-maven-3-8-6-java-17?icon=github&kill_cache=1)](https://github.com/mandreljava/base.images.debian.11-bullseye.mandrel.22-3.java.17.mandrel-22-3-maven-3-8-6-java-17/tags/###CI_COMMIT_TAG###)
&nbsp;
...
## 5. Image coordinates:
```  
docker pull mandreljava/base.images.debian.11-bullseye.mandrel.22-3.java.17.mandrel-22-3-maven-3-8-6-java-17:###CI_COMMIT_TAG###
```

## 6. Available Docker images and tags:
```
REPOSITORY                                                                                        TAG                    SIZE
mandreljava/base.images.debian.11-bullseye.mandrel.22-3.java.17.mandrel-22-3-maven-3-8-6-java-17  ###CI_COMMIT_TAG###                  933.52MB
